package lankTest;
	...
	public class BeforeLankManager {
				...
				while (true) {
					...
					case 2:
						...
						for (int i = 0; i < lank1.size(); i++) {
							if (searchName.equals(lank1.get(i).name)) {
								index = i;
								break;
							}
						}
				...
				while (true) {
					...
					case 2:
						...
						for (int i = 0; i < lank2.size(); i++) {
							if (searchName.equals(lank2.get(i).name)) {
								index = i;
								break;
							}
						}
		...
		while (true) {
			...
			case 2:
				...
				for (int i = 0; i < lank3.size(); i++) {
					if (searchName.equals(lank3.get(i).name)) {
						index = i;
						break;
					}
				}
		...
		while (true) {
			...
			case 2:
				...
				for (int i = 0; i < lank4.size(); i++) {
					if (searchName.equals(lank4.get(i).name)) {
						index = i;
						break;
					}
				}
