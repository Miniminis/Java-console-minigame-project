...
public class UserInfoManager implements UserInfoInterface{
	...
	final Map<String, UserInfo> userinfo = new HashMap<String, UserInfo>();
	...
	public void login() {
		...
		if (!(userinfo.containsKey(id))) {
			...
			printSubMenu(id, userinfo.get(id).getNickname());
